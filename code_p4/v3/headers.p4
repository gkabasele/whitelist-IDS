...
header_type idstag_t {
    fields {
        val : 64;       // value set by the IDS to specify that the packet has been inspecting 
        proto : 8; //original transport protocol
...
field_list_calculation transId_hash_client{
    input{
        hash_fields_client;
    }
    algorithm : csum16;
...
field_list_calculation transId_hash_server{
    input{
        hash_fields_server;
    }
    algorithm : csum16;
