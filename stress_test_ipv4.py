...
def configure_dp(commands_path, thrift_port):
    cmd = ["/home/mininet/p4-tutorials/bmv2/tools/runtime_CLI.py",
    ...
    with open(commands_path, "r") as f:
        ...
        sub_env["PYTHONPATH"] = pythonpath + \
                                "/home/mininet/p4-tutorials/bmv2/thrift_src/gen-py/"
...
def main():
    ...
    sw_path = "/home/mininet/p4-tutorials/bmv2/targets/simple_switch/simple_switch"
    json_path = "/home/mininet/p4-tutorials/bmv2/mininet/simple_router.json"
    ...
    configure_dp("/home/mininet/p4-tutorials/bmv2/mininet/stress_test_commands.txt", thrift_port)
