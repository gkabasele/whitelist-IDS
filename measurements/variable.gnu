set output "graph-variable2.png"
...
plot "state2_normal.csv" using 1:15 title "Tank1-Normal" with linespoints ls 1, \
     "attack2_normal.csv" using 1:15 title "Tank1-Attack" with linespoints ls 2
